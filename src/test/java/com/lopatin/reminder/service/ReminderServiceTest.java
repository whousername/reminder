...
//        Reminder entityBeforeSave = new Reminder(null, "test1", "test1", time, user_id, ReminderStatus.PENDING);
//        Reminder entityAfterSave = new Reminder(1L, "test1", "test1", time, user_id, ReminderStatus.PENDING);
